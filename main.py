...
def update_movie(id : int, movie: Movie) -> dict:
    ...
    return JSONResponse(content = {"mesage": "Se ha actualizado correctamente la informacion de la pelicula"})
...
def delete_movie(id: int) -> dict:
    for item in movies:
        if item["id"] == id:
            movies.remove(item)
            return JSONResponse(content={"mesage": "Se ha eliminado correctamente la pelicula"})
